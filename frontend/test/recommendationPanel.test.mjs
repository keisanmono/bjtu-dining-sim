...
test('simulation preview renders a realistic cafeteria floor plan', () => {
  ...
  assert.equal(appSource.includes('floor-zone'), false)
  assert.equal(appSource.includes('entrance-zone'), true)
  assert.equal(appSource.includes('entrance-door'), true)
  assert.equal(appSource.includes('service-counter-bank'), true)
  ...
  assert.equal(styleSource.includes('.dining-floor-plan::before'), true)
  assert.equal(styleSource.includes('.floor-zone'), false)
  assert.equal(styleSource.includes('.service-zone {\n  position: absolute;'), true)
  assert.equal(styleSource.includes('.seating-zone {\n  position: absolute;'), true)
